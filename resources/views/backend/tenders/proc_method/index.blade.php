...
<div class="card shadow">
    <div class="card-body">
        <form action="{{ route('manage_proc_method.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @can('product-delete')
                        {!! Form::open(['method' => 'DELETE','route' => ['manage_proc_method.destroy', $item->description_lao],'style'=>'display:inline']) !!}
