                            ...
                            <div class="row">
                                <div class="col-md-6 offset-md-3">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form method="post" action="{{route('addNews.store')}}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="form-group">
                                                    <label for="name">ລາວ</label>
                                                    <input type="text" Name="name_lo" class="form-control" required/>
                                                </div>
                                                <div class="form-group">
                                                    <label for="name">ອົງກີດ</label>
